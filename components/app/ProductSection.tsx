  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-8 lg:flex-row">
        {/* Sidebar Filters - sticky positioning so it stays visible while scrolling */}
        <aside
          className={`shrink-0 transition-all duration-300 ease-in-out lg:sticky lg:top-4 lg:h-fit ${
