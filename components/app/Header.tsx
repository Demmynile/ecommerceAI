...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-zinc-200 bg-white/80 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-950/80">
      <div className="mx-auto flex h-16 md:h-20 lg:h-24 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2 py-2">
          <Image
            ...
            width={300}
            height={100}
            className="h-12 md:h-16 lg:h-24 w-auto px-1 md:px-2"
            priority
          />
        </Link>
